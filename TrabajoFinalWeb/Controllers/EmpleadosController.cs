...
namespace TrabajoFinalWeb.Controllers
{
    ...
    public class EmpleadosController : Controller
    {
        ...
        public ActionResult Index(string Titulo)
        {
            ...
            var empleadosb = from s in db.Empleadoes select s;
            if (!string.IsNullOrEmpty(Titulo)) {

                empleadosb = empleadosb.Where(s => s.Nombre.Contains(Titulo));
                return View(empleadosb.ToList());
        ...
        public ActionResult Login([Bind(Include = "ID,Contraseña,IdTipoEmpleado,Nombre,Celular,Correo,Direccion,Sueldo")] Empleado user)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewBag.ErrorMessage = "Incorreto, por favor reintente";
                }
        ...
        public void enviarEMail(string correo,string password)
        {
            ...
            Correo.From = new MailAddress("stiivters@gmail.com");
            ...
            ServerEmail.Credentials = new NetworkCredential("CorreoHCB@gmail.com", "contraseñaHCB");
